...
- containerStyle (default {    backgroundColor: "grey",})
...
- sidebarSize (string | number; default 250)
...
- splitMode (a value equal to: 'vertical', 'horizontal'; default 'vertical')"""
    ...
    _type = 'DashPaneSplit'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, resizerSize=Component.UNDEFINED, sidebarSize=Component.UNDEFINED, panelOrder=Component.UNDEFINED, splitMode=Component.UNDEFINED, mainChildren=Component.UNDEFINED, sidebarChildren=Component.UNDEFINED, mainStyle=Component.UNDEFINED, sidebarStyle=Component.UNDEFINED, containerStyle=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'containerStyle', 'mainChildren', 'mainStyle', 'panelOrder', 'resizerSize', 'sidebarChildren', 'sidebarSize', 'sidebarStyle', 'splitMode']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'containerStyle', 'mainChildren', 'mainStyle', 'panelOrder', 'resizerSize', 'sidebarChildren', 'sidebarSize', 'sidebarStyle', 'splitMode']
