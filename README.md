...
dash pane split is a Dash component library.
...
- Add custom styles to your component by putting your custom CSS files into your distribution folder (`dash_pane_split`).
    ...
    - Make sure the stylesheets are added to the `_css_dist` dict in `dash_pane_split/__init__.py` so dash will serve them automatically when the component suite is requested.
